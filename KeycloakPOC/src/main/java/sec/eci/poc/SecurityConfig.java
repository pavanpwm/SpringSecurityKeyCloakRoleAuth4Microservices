...
// dont forget to change allowed origins in WebConfig.java class in application.properties file 
//api.allowed.origins=*


//how to make a jar out of maven project??
//right click on prject -> Maven -> Update project
//Run as --> maven clean then maven install
//the jar file is created in traget follder of maven project

//how to import in your project
//add the jar to build path of you project
